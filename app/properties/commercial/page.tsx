...
import { ArrowLeft, MapPin, Grid3X3, List, Zap, Building2, Store } from 'lucide-react'
...
const COMMERCIAL_TYPES = ['office', 'shop', 'commercial', 'showroom', 'warehouse', 'retail', 'sco', 'scf', 'multiplex']
...
export default function CommercialPropertiesPage() {
  ...
  // Build query string for commercial properties
  const buildQueryString = () => {
    const params: string[] = COMMERCIAL_TYPES.map((type) => `property_type=${type}`)
    return params.join('&')
  }
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-8">
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="text-primary text-sm font-semibold uppercase tracking-wider">Business Spaces</span>
              </div>
              <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-3">Commercial Properties</h1>
              <p className="text-muted-foreground max-w-2xl">
                Premium office spaces, retail shops, showrooms, and commercial complexes in strategic business locations. 
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              ...
              <span className="px-3 py-1.5 text-xs font-medium bg-primary/10 text-primary rounded-full">SCO/SCF</span>
              <span className="px-3 py-1.5 text-xs font-medium bg-primary/10 text-primary rounded-full">Showrooms</span>
              <span className="px-3 py-1.5 text-xs font-medium bg-primary/10 text-primary rounded-full">Warehouses</span>
            </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    router.push(`/properties/commercial?${query.toString()}`)
                  }}
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          {isLoading ? (
            ...
            <div className="text-center py-16">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-2">No Commercial Properties Found</h3>
              <p className="text-muted-foreground mb-6">
                We don&apos;t have any commercial properties available right now.
              </p>

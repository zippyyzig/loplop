...
import { ArrowLeft, MapPin, Grid3X3, List, Zap, Home, Building2 } from 'lucide-react'
...
const RESIDENTIAL_TYPES = ['apartment', 'villa', 'house', 'flat', 'penthouse', 'duplex', 'studio', 'independent', 'row house', 'bungalow', 'farmhouse']
...
export default function ResidentialPropertiesPage() {
  ...
  // Build query string for residential properties
  const buildQueryString = () => {
    const params: string[] = RESIDENTIAL_TYPES.map((type) => `property_type=${type}`)
    return params.join('&')
  }
        ...
        <div className="bg-card border-b border-border px-4 py-8 md:py-12">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-3">Residential Properties</h1>
              <p className="text-muted-foreground max-w-2xl">
                Discover premium apartments, villas, penthouses, and independent floors in prime locations. 
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              ...
              <span className="px-3 py-1.5 text-xs font-medium bg-primary/10 text-primary rounded-full">Villas</span>
              <span className="px-3 py-1.5 text-xs font-medium bg-primary/10 text-primary rounded-full">Penthouses</span>
              <span className="px-3 py-1.5 text-xs font-medium bg-primary/10 text-primary rounded-full">Duplexes</span>
              <span className="px-3 py-1.5 text-xs font-medium bg-primary/10 text-primary rounded-full">Independent Floors</span>
            </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    router.push(`/properties/residential?${query.toString()}`)
                  }}
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          {isLoading ? (
            ...
            <div className="text-center py-16">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-2">No Residential Properties Found</h3>
              <p className="text-muted-foreground mb-6">
                We don&apos;t have any residential properties available right now.
              </p>
